    ...
    <div key={title} className={"block max-w-sm my-6 rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]"}>
      ...
      <div className={"p-6"}>
        ...
        <Link
          ...
          className={"inline-block w-full font-medium transition-colors bg-yellow-200 hover:bg-yellow-300 rounded-md focus:outline-none focus:ring-offset-2 focus:ring focus:ring-amber-200 px-7 py-4 text-center"}
          data-te-ripple-init
